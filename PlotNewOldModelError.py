...
show_images(final_lists, 1, titles="Error of New and Old Best Models")
...
show_images(avg_lists, 2, titles="Error of New and Old Best Models divided by average rainfall")
