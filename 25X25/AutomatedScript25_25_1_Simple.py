...
def run_models(grid_y, grid_x):
    ...
    with open("models25_25_1s/"+str(grid_x)+str(grid_y)+"_lin.pickle", "wb") as f:
        pickle.dump(lin, f)
    with open("models25_25_1s/"+str(grid_x)+str(grid_y)+"_rf.pickle", "wb") as f:
        pickle.dump(rf, f)
    with open("models25_25_1s/"+str(grid_x)+str(grid_y)+"_nnr.pickle", "wb") as f:
        pickle.dump(nnr, f)
    with open("models25_25_1s/"+str(grid_x)+str(grid_y)+"_svm.pickle", "wb") as f:
        pickle.dump(svm, f)
    with open("models25_25_1s/"+str(grid_x)+str(grid_y)+"_knn.pickle", "wb") as f:
        pickle.dump(knn, f)
...
check = open('ModelsInfo_25_25_1s.csv', 'w')
check.truncate()
check.write(str('Y'))
check.write(', ')
check.write(str('X'))
...
countMAE = 0
countRMSE = 0
for grid_y in range(1, 46):
    for grid_x in range(1, 67):
        ...
        if flag:
            ...
            np.savetxt('test_25_25_1s/' + str(grid_x) + '_' + str(grid_y) + '.csv', test.Y, delimiter=',', fmt='%10.5f')
            np.savetxt('pred_25_25_1s/' + str(grid_x) + '_' + str(grid_y) + '.csv', predictions, delimiter=',', fmt='%10.5f')
            np.savetxt('mae_25_25_1s/' + str(grid_x) + '_' + str(grid_y) + '.csv', mae, delimiter=',', fmt='%10.5f')
            np.savetxt('rmse_25_25_1s/' + str(grid_x) + '_' + str(grid_y) + '.csv', rmse, delimiter=',', fmt='%10.5f')
