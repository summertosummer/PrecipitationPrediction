    ...
    for grid_y in range(0, 10):
        for grid_x in range(0, 1683):
            ...
            if flag:
                ...
                np.savetxt('test1155_1683_1s/' + str(grid_x) + '_' + str(y2) + '.csv', test.Y, delimiter=',', fmt='%10.5f')
                np.savetxt('pred1155_1683_1s/' + str(grid_x) + '_' + str(y2) + '.csv', predictions, delimiter=',', fmt='%10.5f')
                np.savetxt('mae1155_1683_1s/' + str(grid_x) + '_' + str(y2) + '.csv', mae, delimiter=',', fmt='%10.5f')
                np.savetxt('rmse1155_1683_1s/' + str(grid_x) + '_' + str(y2) + '.csv', rmse, delimiter=',', fmt='%10.5f')
